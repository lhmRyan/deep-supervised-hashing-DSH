function [topN_idx, topN, map] = compute_map_multi(dis_mtx, query_label, database_label)
% tic;
...
result_mtx = bitand(sorted_database_label_mtx, repmat(query_label', d_num, 1))>0;
